...
import vct100.libs.mongolib as mongo
...
from vct100.libs.datatypelib import StrDT, DataTypeError, DatetimeDT
from vct100.libs.configlib import Config, ConfigList
from vct100.libs.options import config as base_config
...
class BaseModel(object):
    ...
    def get_model(cls, model_name):
        try:
            ...
            model_name = 'vct100.apps.%s.model' % (app_name)
