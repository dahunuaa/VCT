...
from vct100.bootstrap import exceptions
from vct100.libs import utils
from vct100.libs.oauthlib import validate_token
from vct100.libs.asynclib import AsyncUtils
from vct100.libs.options import config
from .model import BaseModel

try:
    import importlib
except:
    from vct100.libs import importlib
...
class APIHandler(BaseAPIHandler):
    ...
    def finish(self, chunk=None, notification=None, origin=False, status_code=200):
        ...
        if callback:
            ...
            self.set_header("Content-Type", "application/json; charset=UTF-8")
            self.set_header("Server", "vct100 API server/v0.1.0")
